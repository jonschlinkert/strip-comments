...
/**
 * HTML Comments must have the following format:
 *
 *    1. Begin with the string "<!--".
 *    2. Optional text, which must not start with the string ">", or start
 *       with the string "->", or contain the strings "<!--", "-->", or "--!>",
 *       or end with the string "<!-".
 *    3. End with the string "-->".
 *
