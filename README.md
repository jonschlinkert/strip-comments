...
> Strip line and/or block comments from a string. Works with JavaScript, Sass, CSS, Less.js, or any comments with the same format as JavaScript.
...
| **Commits** | **Contributor** |  
| --- | --- |  
| 76 | [jonschlinkert](https://github.com/jonschlinkert) |  
...
_This file was generated by [verb-generate-readme](https://github.com/verbose/verb-generate-readme), v0.8.0, on November 04, 2019._