...
describe('strip:', function() {
  ...
  it.skip('should not strip non-comments in string literals', function() {
  ...
  it.skip('should not hang on unclosed comments', function() {
  ...
  it.skip('should not mangle json', function() {
...
describe('error handling:', function() {
  it('should throw TypeError when not a string passed', function(cb) {
    function fixture() {
      strip(123);
    }
  ...
  it('should throw TypeError when not a string passed to `.block`', function(cb) {
    function fixture() {
      strip.block(123);
    }
    assert.throws(fixture, TypeError);
  ...
  it('should throw TypeError when not a string passed to `.line`', function(cb) {
    function fixture() {
      strip.line(123);
    }
    assert.throws(fixture, TypeError);
